...
<head>
    <meta charset="UTF-8">
    <title>Degree College Shikaripara | Visting Faculty</title>
    <!--Style Starts-->
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10">
                                ...
                                <br/> Contact : <b>director@degreecollegeshikaripara.ac.in</b>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10">
                                ...
                                <br/> Contact : <b>maniklal.das@degreecollegeshikaripara.ac.in</b>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10">
                                ...
                                <br/> Contact : <b>rahul_dubey@degreecollegeshikaripara.ac.in</b>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10">
                                ...
                                <br/> Contact : <b>gagan_garg@degreecollegeshikaripara.ac.in</b>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10">
                                ...
                                <br/> Contact : <b>pm_jat@degreecollegeshikaripara.ac.in</b>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10">
                                ...
                                <br/> Contact : <b>p_majumder@degreecollegeshikaripara.ac.in</b>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item">
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10">
                                ...
                                <br/> Contact : <b>suman_mitra@degreecollegeshikaripara.ac.in</b>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10">
                                ...
                                <br/> Contact : <b>rahul_muthu@degreecollegeshikaripara.ac.in</b>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10">
                                ...
                                <br/> Contact : <b>alka_parikh@degreecollegeshikaripara.ac.in</b>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item">
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10">
                                ...
                                <br/> Contact : <b> hemant_patil@degreecollegeshikaripara.ac.in</b>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10">
                                ...
                                <br/> Contact : <b>minal_bhise@degreecollegeshikaripara.ac.in</b>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10">
                                ...
                                <br/> Contact : <b> nandini_banerjee@degreecollegeshikaripara.ac.in</b>
                            </div>
                        </div>
                    </li>
                </ul>
